...
public class SwerveConstants {
    ...
    public static final int FRONT_LEFT_TRUE_NORTH_ENC_POS = 420;
    public static final int FRONT_RIGHT_TRUE_NORTH_ENC_POS = 391;
    public static final int BACK_LEFT_TRUE_NORTH_ENC_POS = -270;
