...
public class SwerveConstants {
    ...
    public static final int FRONT_LEFT_TRUE_NORTH_ENC_POS = 605;
    // Analog: Pos: -453u   |   Vel: 0u/100ms   |   ADC:571   |   1.7 V
    public static final int FRONT_RIGHT_TRUE_NORTH_ENC_POS = 644;
    // Analog: Pos: 245u   |   Vel: 0u/100ms   |   ADC:245   |   0.8 V
    public static final int BACK_LEFT_TRUE_NORTH_ENC_POS = 273;
    // Analog: Pos: 679u   |   Vel: 2u/100ms   |   ADC:679   |   2.2 V
    public static final int BACK_RIGHT_TRUE_NORTH_ENC_POS = 776;
