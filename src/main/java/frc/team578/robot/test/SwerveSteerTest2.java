...
public class SwerveSteerTest2 extends TimedRobot {

    private static final Logger log = LogManager.getLogger(SwerveSteerTest2.class);
...
//        br_talon.set(ControlMode.Position, br_sens_tn);
        ...
        fl_talon.set(ControlMode.PercentOutput, .5);
        fr_talon.set(ControlMode.PercentOutput, .5);
        bl_talon.set(ControlMode.PercentOutput, .5);
        br_talon.set(ControlMode.PercentOutput, .5);
